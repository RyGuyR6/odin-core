...
cat > odin_mcp/services/validation_service.py <<'PY'
...
cat > scripts/test_validation_service.py <<'PY'
from pathlib import Path
...
python -m compileall -q \
    ...
    scripts/test_validation_service.py

echo
echo "✓ ValidationService created."
echo
echo "Run:"
echo "python scripts/test_validation_service.py"
