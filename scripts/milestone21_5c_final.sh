...
printf '\n============================================================\n'
printf 'ODIN MILESTONE %s — RESTART-SAFE RUNTIME LIFECYCLE\n' "$MILESTONE"
printf '============================================================\n'
...
BACKUP_DIR="$ROOT/.odin-backups/milestone21_5c_final/$STAMP"
...
printf '  • Restart-safe ServiceContainer state transitions\n  • Enum-safe, metadata-driven required service readiness\n'
