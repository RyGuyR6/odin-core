...
mkdir -p odin_mcp/core

cat > odin_mcp/core/orchestrator.py <<'PY'
...
python -m compileall -q \
    ...
    scripts/test_odin.py

echo
echo "======================================"
echo " Odin Orchestrator Installed"
echo "======================================"
echo
echo "Run:"
echo
echo "python scripts/test_odin.py"
echo
