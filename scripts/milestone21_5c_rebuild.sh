...
printf '\n============================================================\n'
printf 'ODIN MILESTONE %s — CLEAN RUNTIME LIFECYCLE REBUILD\n' "$MILESTONE"
printf '============================================================\n'
...
BACKUP_DIR="$ROOT/.odin-backups/milestone21_5c_rebuild/$STAMP"
...
print("Exact eager-health readiness probe passed")
PY
)
ok "Exact eager-health readiness probe passed"
...
printf '  • Enum-safe, metadata-driven required service readiness\n'
