...
| OW-007 Native AI Chat | Complete | Full streaming chat UI with conversation sidebar, markdown rendering, syntax-highlighted code blocks with copy buttons, stop generation, edit & resend, regenerate, token usage display, conversation CRUD, archive/delete/rename, search, and auto-title. Built on OIC-008 ChatService provider abstraction. | OW-002, OW-003, OIC-008 |
